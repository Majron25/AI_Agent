        ...
        while frontier :#and index > 0:
            ...
            for i in range(5):
                    ...
                    for cell in self.map.cells: 
                        if cell.visited == False:
                            if cell.x == self.agent.x and cell.y == self.agent.y -1 in range(0,self.map.height):
                                if cell not in visited and cell.wall == False:
                ...
                if self.agent.goal == True:
                    ...
                    for cell in self.map.cells:
                        if cell in visited or cell in frontier:
                            count = count + 1
                    return True, "The number of nodes:", count
                if i == 4:
                    #frontier.pop(0)
                    #print(frontier[0] not in visited)
                    #frontier.remove(firstel)
                    firstel = frontier[0]
                    self.agent.agent = False
                    self.agent = firstel
                    self.agent.agent = True
